# ADR-020: Terraform AWS/GCP Multi-Region Production Deployments
...
## Decision
We implement `Terraform AWS/GCP Multi-Region Production Deployments` as a first-class citizen in the AegisAI architecture.
