# ADR-013: Server-Sent Events for Real-Time Multi-Agent Reasoning Progress
...
## Decision
We implement `Server-Sent Events for Real-Time Multi-Agent Reasoning Progress` as a first-class citizen in the AegisAI architecture.
