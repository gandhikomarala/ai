# ADR-018: Next.js 14 App Router with Tailwind and Lucide Icons
...
## Decision
We implement `Next.js 14 App Router with Tailwind and Lucide Icons` as a first-class citizen in the AegisAI architecture.
