# ADR-008: Enforced Read-Only SQL Parsing with AST Query Boundaries
...
## Decision
We implement `Enforced Read-Only SQL Parsing with AST Query Boundaries` as a first-class citizen in the AegisAI architecture.
