# ADR-006: Hunk-level Semantic Diff Analysis for Incidents
...
## Decision
We implement `Hunk-level Semantic Diff Analysis for Incidents` as a first-class citizen in the AegisAI architecture.
