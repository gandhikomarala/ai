"""
AegisAI Gateway — Multi-Model LLM Developer Workbench — JSON Schema Structured Output Validator (Unit 014)
...
@dataclass
class SchemaValidatorState_014:
    state_id: str
    is_valid: bool
...
class SchemaValidator_014:
    ...
    def __init__(self, node_tag: str = "node_ai_014"):
        ...
        self.active_state_cache: Dict[str, SchemaValidatorState_014] = {}

    def execute_processing_cycle(self, input_data: List[float], user_context: str = "production_client") -> SchemaValidatorState_014:
        self.invocations += 1
        ...
        state = SchemaValidatorState_014(
