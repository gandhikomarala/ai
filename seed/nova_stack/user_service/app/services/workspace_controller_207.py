...
class WorkspaceController207:
    ...
    async def create_project(self, project_name: str, owner_email: str, quota_mb: int = 5000) -> Dict[str, Any]:
        ...
        logger.info(f"[Workspace-207] Created project {proj_id} ({project_name}) for {owner_email}")
        return project
